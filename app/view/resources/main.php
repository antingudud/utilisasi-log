...
<body class="h-screen">
    <nav class="sticky top-0 z-50 flex items-center h-24 w-screen max-h-28 bg-slate-900">
    ...
    <section id="mainbody" class="container relative w-screen h-screen pr-6 pl-6 pt-6 pb-6 items-center justify-center">
